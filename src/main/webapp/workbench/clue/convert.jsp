...
<script type="text/javascript">
	$(function(){
        ...
        $("#return").click(function (){
        	window.location.href = '../clue/index.jsp';
		})
        ...
        $("#aname").keydown(function (event){
            if (event.keyCode==13){
                $.ajax({
                    url:"getActivityListByNameTwo.do",
                    data:{
                        "name" : $.trim($("#aname").val())
                    },
                    type:"get",
		...
		$("#convertBtn").click(function (){
			//提交请求到后台，执行线索转换的操作，应该发出传统请求，请求结束后回到线索列表页
			//根据为客户创建交易的复选框有没有选中来判断是否需要创建交易
...
<%--							</tr>--%>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="btn btn-default" type="button" id="return" value="取消">
	</div>
</body>
</html>