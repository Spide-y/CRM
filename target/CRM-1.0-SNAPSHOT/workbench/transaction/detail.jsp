<%@ page import="com.gdufe.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.gdufe.crm.workbench.domain.Tran" %>
...
<script type="text/javascript">
	...
	function changeIcon(stage,index){
		...
		//如果当前阶段的可能性为0，前7个一定是黑圈，后两个一个红叉、一个黑叉
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='edit.do?id=${t.id}';"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			if ("0".equals(currentPossibility)){
				for (int i=0;i<dvList.size();i++){
					...
					//如果遍历出来的可能性为0,说明是后两个一个是红叉，一个是黑叉
		...
		<%
				...
				//如果不为0，前7个有可能性是绿圈，绿色标记，黑圈，后两个一定是黑叉
				//准备当前阶段的分界点
				int index = 0;
				for (int i=0;i<dvList.size();i++){
					DicValue dv = dvList.get(i);
